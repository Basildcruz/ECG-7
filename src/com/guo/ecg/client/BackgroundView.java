...
public class BackgroundView extends View {
	...
	public BackgroundView(Context context, AttributeSet attrs, int inflateParams){
...
//		canvas.drawLine(Width*14/20, Height/2, Width*14/20, Height, paint);
		...
		canvas.drawLine(Width*16/20, 0, Width*16/20, Height, paint);
		
//		paint.setColor(Color.argb(255, 200, 50, 0));
//		paint.setStrokeWidth(2);
		H = Height/4;
		W = Width/10;
		canvas.drawLine(W*2,3*H,W*2,4*H, paint);
		canvas.drawLine(W*3,3*H,W*3,4*H, paint);
